...
const itemList = document.querySelector(".item-list"); //items on the list
const feedback = document.querySelector(".feedback"); // feedback
const addBtn = document.querySelector("#add-item"); //for adding items
const clearButton = document.querySelector("#clear-list");  // clearing out items from list
